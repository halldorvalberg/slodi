...
export default function DashboardPage() {
    return (
        <div className={styles.dashboardPage}>
            ...
            <p className={styles.subtitle}>Hér verða alls kyns yfirlit og upplýsingar seinna, en núna er þetta bara smá lendingarpallur sem beinir þér inn á dagskrárbankann.</p>
