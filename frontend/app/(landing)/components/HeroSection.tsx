            ...
            <div className={styles.container}>
                <div className={styles.content}>
                    <h1 className={styles.heading}>
                        Slóði
                        <span className={styles.subtitle} aria-label="Undirtitill">Meira en bara dagskrárvefur</span>
                    </h1>
                    ...
                    <p className={styles.description}>
                        Slóði er opinn hugbúnaður sem hjálpar skátaforingjum að skipuleggja dagskrár,
                        deila hugmyndum og fylgjast með fjölbreytni í starfinu. Sameiginlegur hugmyndabanki
                        og verkfæri til að gera dagskrárgerð einfaldari og markvissari.
                    </p>
